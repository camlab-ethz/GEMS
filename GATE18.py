...
class GATE18a(nn.Module):
    def __init__(self, dropout_prob, in_channels, edge_dim, conv_dropout_prob):
        super(GATE18a, self).__init__()

        self.NodeTransform = FeatureTransformMLP(in_channels, 256, 128, dropout=dropout_prob)
        
        self.layer1 = self.build_layer( node_f=128, node_f_hidden=128, node_f_out=128, 
        ...
        self.layer2 = self.build_layer( node_f=128, node_f_hidden=128, node_f_out=128,
                                        edge_f=128, edge_f_hidden=128, edge_f_out=128,
                                        glob_f=512, glob_f_hidden=768, glob_f_out=768,
                                        residuals=False, dropout=conv_dropout_prob
                                        )
...
class GATE18b(nn.Module):
    def __init__(self, dropout_prob, in_channels, edge_dim, conv_dropout_prob):
        super(GATE18b, self).__init__()
...
class GATE18c(nn.Module):
    def __init__(self, dropout_prob, in_channels, edge_dim, conv_dropout_prob):
        super(GATE18c, self).__init__()
