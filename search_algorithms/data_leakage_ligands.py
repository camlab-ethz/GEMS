...
plt.savefig(f'data_leakage_test/CASF2016_ligands_{data_split}_top{top_n}', dpi=300)
...
plt.savefig(f'data_leakage_test/CASF2013_ligands_{data_split}_top{top_n}', dpi=300)