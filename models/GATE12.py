...
GATE12a: 2 layers, no residuals
GATE12b: 3 layers, no residuals
GATE12ar: 2 layers, with residuals
GATE12br: 3 layers, with residuals
...
class GATE12b(nn.Module):
    def __init__(self, dropout_prob, in_channels, edge_dim, conv_dropout_prob):
        super(GATE12b, self).__init__()
