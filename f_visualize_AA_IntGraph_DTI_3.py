...
def visualize_graph(graph, 
    ...
    if show_edge_attr:
        ...
        edge_list, _ = remove_self_loops(graph.edge_index_master)
        edge_list = edge_list.T.tolist()
    ...
    atomtypes = (graph.x[:,320:329] == 1).nonzero(as_tuple=True)[1].tolist() #identify the index of the first 1 in the feature matrix = atom type
    print(atomtypes)
