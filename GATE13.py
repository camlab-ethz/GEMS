...
GATE13a: 2 layers, no residuals
GATE13b: 3 layers, no residuals
GATE13ar: 2 layers, with residuals
GATE13br: 3 layers, with residuals
...
class GATE13b(nn.Module):
    def __init__(self, dropout_prob, in_channels, edge_dim, conv_dropout_prob):
        super(GATE13b, self).__init__()
