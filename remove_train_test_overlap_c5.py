...
log_file = open('dataset_filtering/C5/training_set_filtering.log', 'w')
...
for test_idx, test_complex in test_set:
    ...
    mask = (train_or_test == 1) & (metrics[:, 2] > 0.8) & (metrics[:, 0] + (1 - metrics[:, 3]) > 0.8)
...
split_dict['casf2016_c5'] = casf2016_filtered
split_dict['casf2013_c5'] = casf2013_filtered

with open('dataset_filtering/C5/PDBbind_c5_data_split.json', 'w', encoding='utf-8') as json_file:
    json.dump(split_dict, json_file, ensure_ascii=False, indent=4)

with open('dataset_filtering/C5/train_test_similarities_casf2016.json', 'w', encoding='utf-8') as json_file:
    json.dump(train_test_sims_casf2016, json_file, ensure_ascii=False, indent=4)

with open('dataset_filtering/C5/train_test_similarities_casf2016_n.json', 'w', encoding='utf-8') as json_file:
    json.dump(train_test_sims_casf2016_n, json_file, ensure_ascii=False, indent=4)

with open('dataset_filtering/C5/train_test_similarities_casf2013.json', 'w', encoding='utf-8') as json_file:
    json.dump(train_test_sims_casf2013, json_file, ensure_ascii=False, indent=4)

with open('dataset_filtering/C5/train_test_similarities_casf2013_n.json', 'w', encoding='utf-8') as json_file:
