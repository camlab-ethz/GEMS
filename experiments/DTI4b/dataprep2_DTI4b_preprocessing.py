...
affinity_dict = load_object(f'/data/grbv/PDBbind/v2020_general_affinity_dict.pkl')
...
log_file_path = os.path.join(log_folder, "preprocessing_distance2.txt")
...
for protein_id, ligand_path, protein_path in zip(protein_ids, ligand_paths, protein_paths):
    ...
    filepath = os.path.join(save_dir, f'{protein_id}_connections_distance.pkl')
