...
log_file_path = os.path.join(log_folder, "preprocessing_DTI4b5.txt")
...
# for protein_id, ligand_path, protein_path in zip(protein_ids[ind-10:ind+10], ligand_paths[ind-10:ind+10], protein_paths[ind-10:ind+10]):
for protein_id, ligand_path, protein_path in zip(protein_ids, ligand_paths, protein_paths):
    ...
    filepath = os.path.join(save_dir, f'{protein_id}_connections_DTI4b5.pkl')
