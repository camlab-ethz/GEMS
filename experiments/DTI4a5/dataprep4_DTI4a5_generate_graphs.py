...
num_atomfeatures = 40
num_edgefeatures = 17
output_folder = f'/data/grbv/PDBbind/DTI_4a5/input_graphs_{embedding_descriptor}/'
...
for complex_id, folder_path, protein_path, ligand_path in zip(complexes, folder_paths, protein_paths, ligand_paths):
    ...
    try:
        connections_dict = load_object( os.path.join(folder_path, f'{complex_id}_connections_DTI4a5.pkl') )
