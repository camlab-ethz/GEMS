...
folder_path = '/data/grbv/PDBbind/DTI_5_c2'

casf2016_dir = '/data/grbv/PDBbind/DTI_5_c2/input_graphs_esm2_t6_8M/test_data/casf2016'
casf2013_dir = '/data/grbv/PDBbind/DTI_5_c2/input_graphs_esm2_t6_8M/test_data/casf2013'
...
def analyse_cluster(name, data):
    ...
    #--------------------------------------------------------------------------------------------------
    db_file = f'/data/grbv/PDBbind/DTI_5_c2/clusters/{name}_db_smiles.h5'
