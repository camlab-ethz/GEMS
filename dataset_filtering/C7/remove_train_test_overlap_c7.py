...
log_file = open('dataset_filtering/C7/training_set_filtering.log', 'w')
...
with open('dataset_filtering/C7/PDBbind_c7_data_split.json', 'w', encoding='utf-8') as json_file:
    json.dump(split_dict, json_file, ensure_ascii=False, indent=4)

with open('dataset_filtering/C7/train_test_similarities_casf2016.json', 'w', encoding='utf-8') as json_file:
    json.dump(train_test_sims_casf2016, json_file, ensure_ascii=False, indent=4)

with open('dataset_filtering/C7/train_test_similarities_casf2016_n.json', 'w', encoding='utf-8') as json_file:
    json.dump(train_test_sims_casf2016_n, json_file, ensure_ascii=False, indent=4)

with open('dataset_filtering/C7/train_test_similarities_casf2013.json', 'w', encoding='utf-8') as json_file:
    json.dump(train_test_sims_casf2013, json_file, ensure_ascii=False, indent=4)

with open('dataset_filtering/C7/train_test_similarities_casf2013_n.json', 'w', encoding='utf-8') as json_file:
